    ...
    return (
        <div className="bg-white w-[300px] min-h-screen p-4 shrink-0">
            <div className="flex items-center gap-4" >
                <img className="size-12 rounded-lg" src="https://utfs.io/f/dcc787d3-d841-48cb-b06f-1d5da671f837-1zbfv.jpg" alt="logo"/>
                <h2 className="text-[20px] font-semibold">Rishabh Jain</h2>
            </div>
